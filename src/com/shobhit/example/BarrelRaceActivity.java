 ...
 * Started on : 20th November 2014
 * @author
 *  
 *  This activity starts the game thread and draws
...
SensorEventListener, android.view.View.OnClickListener {
	...
	BarrelRaceModel model = new BarrelRaceModel(BALL_RADIUS);
	private GameRefresh gameRefresher;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		lp.height = screenWidth + BOTTOM_PADDING; //making the canvas square
		...
		try {
			Drawable d = Drawable.createFromStream(getAssets()
					.open("timerparch6.png"), null);
			timeTextView.setBackgroundColor(color.holo_blue_dark);
			timeTextView.setBackground(d);
		} catch (IOException e) {
			e.printStackTrace();
		}
...
/**
 * Function to handle a pause in between the game play
 * If a call comes or the person is interrupted
 */
	@Override
...
/**
 * The game resumes after any interuption
 */
	@Override
 ...
 */
	...
	/**
	 * Drawing logic goes in this method.
	 * 
	 * @param Canvas c
	 *            
	 */
...
//Barrel Circles
	...
	/**
	 * Game Thread that makes the screen again
	 * on every update
	 * 
	 */
	private class GameRefresh extends Thread {
 ...
 */
	...
	public void onClick(View v) {
		...
		case R.id.play_button:
			/**
			 * This starts the time updation
			 */
			model.setStartTime(SystemClock.uptimeMillis());
			gameRefresher = new GameRefresh();
			gameRefresher.start();
